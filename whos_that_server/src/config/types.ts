...
export type CreateS3UploadReq = z.infer<typeof zod.createGameS3UploadReqSchema>;
export type CreateDBUploadReq = z.infer<typeof zod.createGameDbUploadReqSchema>;
...
export type DailyGame = z.infer<typeof zod.dailyGameInfoSchema>;
