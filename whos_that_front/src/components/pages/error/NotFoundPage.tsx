...
const NotFoundPage = () => {
    return (
        <div className="bg-linear-to-b flex w-full flex-col items-center justify-start from-cyan-400 to-cyan-600 to-90% bg-fixed">
            <div className="text-shadow-xs/100 m-auto mt-10 text-center text-2xl text-white">
                ...
                <Link to={"/"}>
                    <button className="w-fill h-18 border-b-9 text-shadow-xs active:shadow-2xs hover:shadow-xs shadow-sm/20 duration-15 mt-[2vh] cursor-pointer rounded-md border-x border-blue-600 bg-blue-500 px-4 py-1 text-2xl font-bold text-neutral-100 shadow-md transition-all hover:border-blue-700 hover:bg-blue-600 active:-translate-y-px active:border-none">
                        Take Me Home
                    </button>
                </Link>
            </div>
