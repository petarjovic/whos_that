...
const WaitingRoom = ({ gameId }: { gameId: string }) => {
    return (
        <>
            <img className="max-2xl:mt-23 mt-32" src={loadingSpinner} alt="Your SVG" />
            <p className="text-shadow-xs/90 mx-auto mt-auto text-4xl font-semibold text-white max-2xl:text-3xl">
                Waiting in room:{" "}
