...
const FeedbackModal = ({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) => {
    ...
    return (
        <ModalLayout
            classNames="flex h-fit w-[97%] max-w-2xl flex-col gap-4 px-6 py-6 text-center 2xl:text-xl"
            isOpen={isOpen}
            handleClose={handleClose}
        >
            <h2 className="text-5xl leading-none font-bold text-cyan-500 text-shadow-sm/20">
                Feedback
            </h2>
            <p className="text-neutral-800 text-lg">
                ...
                a better experience! If you&apos;ve found a bug, have an idea, question, or a good
                ...
                <div className="flex flex-col gap-3 text-left">
                    ...
                    <div className="flex items-center gap-1.5 rounded-xs border inset-shadow-neutral-200 inset-shadow-sm/15 shadow-xs border-neutral-500 bg-neutral-300 px-3 py-2 text-center">
                        <div className="mx-auto">
                            ...
                            >
                                {(
                                    Object.entries(FEEDBACK_LABELS) as [Feedback["type"], string][]
                                ).map(([value, label]) => (
                    ...
                    <div className="flex flex-col gap-1 rounded-xs border border-neutral-500 bg-neutral-300 px-3 py-2 inset-shadow-neutral-200 inset-shadow-sm/15 shadow-xs">
                        ...
                        <textarea
                            ...
                            maxLength={2000}
                            disabled={submitting}
                            className="w-full resize-none rounded border border-neutral-400 bg-neutral-50 p-1.5 text-base font-medium placeholder:text-gray-400 focus:outline-none h-45"
                        />
