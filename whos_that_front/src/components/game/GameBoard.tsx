...
const GameBoard = ({
    ...
    const remainder = cardList.length % numGridCols;
    const mainCards = remainder === 0 ? cardList : cardList.slice(0, -remainder);
    const lastRow = remainder === 0 ? [] : cardList.slice(-remainder);
